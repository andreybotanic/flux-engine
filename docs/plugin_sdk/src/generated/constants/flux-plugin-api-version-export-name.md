...
```rust
pub const FLUX_PLUGIN_API_VERSION_EXPORT_NAME: & [u8] = ...;
```

## SDK Example

_Source: [`examples/constants/flux-plugin-api-version-export-name.md`](../../examples/constants/flux-plugin-api-version-export-name.md)_
