use flux_plugin_sdk::{
    declare_plugin, BuildHudForCellEvent, ContentId, MouseButton, MouseCellEvent, Plugin,
    PluginError, PluginEvent, PluginInit, Registrar, SaveApi, SaveChunkDescriptor, UiApi,
    WorldBeforeSaveEvent, WorldLoadedEvent,
};
