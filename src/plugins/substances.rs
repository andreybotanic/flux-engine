...
///
/// # Fields
/// - `0`: Canonical stable identifier string stored for this substance.
...
///
/// # Fields
/// - `gas`: Whether the substance participates in the gas simulation pipeline.
...
///
/// # Fields
/// - `id`: Stable substance identifier used across content, saves and runtime lookups.
/// - `plugin_id`: Plugin that owns and registers this substance.
/// - `label`: Human-readable label shown in UI and debugging output.
/// - `molecular_mass`: Relative molecular mass used to sort gas substances and simulate buoyancy.
/// - `color`: RGB color used by gas rendering and related UI.
/// - `aliases`: Additional lookup ids accepted by runtime APIs and legacy config.
/// - `flags`: Feature flags that describe which simulation systems can use this substance.
...
///
/// # Fields
/// - `definitions`: All validated substance definitions in compact runtime order.
/// - `by_id`: Index lookup from stable substance id to compact runtime position.
/// - `by_lookup`: Index lookup from stable ids and aliases to compact runtime position.
#[derive(Clone, Debug, PartialEq)]
